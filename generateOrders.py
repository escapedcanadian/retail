    ...
    field_mappings = [
        rs.FieldMapping.mapping(
            ...
            output_field=rs.FieldMapping.output_field(
                ...
                sql_expression = "TRY_CAST(:purchased_str AS TIMESTAMP)",
                on_error="SKIP"
                )
            ),
        rs.FieldMapping.mapping(
            ...
            output_field=rs.FieldMapping.output_field(
                field_name = "approved",
                sql_expression = "TRY_CAST(:approved_str AS TIMESTAMP)",
                on_error="SKIP"
                )
            ),
        rs.FieldMapping.mapping(
            ...
            output_field=rs.FieldMapping.output_field(
                field_name = "delivered_carrier",
                sql_expression = "TRY_CAST(:delivered_carrier_str AS TIMESTAMP)",
                on_error="SKIP"
                )
            ),
        rs.FieldMapping.mapping(
            ...
            output_field=rs.FieldMapping.output_field(
                field_name = "delivered_customer",
                sql_expression = "TRY_CAST(:delivered_customer_str AS TIMESTAMP)",
                on_error="SKIP"
                )
            ),
        rs.FieldMapping.mapping(
            ...
            output_field=rs.FieldMapping.output_field(
                field_name = "estimated_delivery",
                sql_expression = "TRY_CAST(:estimated_delivery_str AS TIMESTAMP)",
                on_error="SKIP"
                )
            )
        ]
